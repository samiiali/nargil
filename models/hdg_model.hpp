...
#ifndef IMPLICIT_HDG_MODEL_HPP
#define IMPLICIT_HDG_MODEL_HPP
...
struct hdg_model : public generic_model<dim, CellType>
{
  ...
  hdg_model() = delete;
  hdg_model(SolutionManager<dim> *const sol_, BDFIntegrator *time_integrator_);
