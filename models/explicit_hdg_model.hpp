...
#ifndef EXPLICIT_HDG_MODEL_HPP
#define EXPLICIT_HDG_MODEL_HPP
 ...
 * to include mesh as part of the hdg_model as well.
 */
template <int dim, template <int> class CellType>
struct explicit_hdg_model : public generic_model<dim, CellType>
{
  ...
  explicit_hdg_model() = delete;
  explicit_hdg_model(SolutionManager<dim> *const sol_,
...
#include "explicit_hdg_model.cpp"
