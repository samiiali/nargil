...
hdg_model<dim, CellType>::hdg_model(SolutionManager<dim> *const sol_,
                                    BDFIntegrator *time_integrator_)
 ...
 */
template <int dim, template <int> class CellType>
void hdg_model<dim, CellType>::init_mesh_containers()
{
 ...
 */
template <int dim, template <int> class CellType>
void hdg_model<dim, CellType>::set_boundary_indicator()
{
 ...
 */
template <int dim, template <int> class CellType>
void hdg_model<dim, CellType>::count_globals()
{
...
template <int dim, template <int> class CellType>
void hdg_model<dim, CellType>::free_containers()
{
...
template <int dim, template <int> class CellType>
bool hdg_model<dim, CellType>::compute_internal_dofs(double *const local_uhat)
{
...
template <int dim, template <int> class CellType>
void hdg_model<dim, CellType>::init_solver()
{
...
template <int dim, template <int> class CellType>
void hdg_model<dim, CellType>::reinit_solver(
