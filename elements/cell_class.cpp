...
GenericCell<dim, spacedim>::GenericCell(dealiiCell &inp_cell,
...
template <int dim, int spacedim>
GenericCell<dim, spacedim>::GenericCell(GenericCell &&inp_cell) noexcept
...
template <int dim, int spacedim>
GenericCell<dim, spacedim>::~GenericCell()
{
}
...
GenericCell<dim, spacedim>::make_cell(dealiiCell &inp_cell,
                                      const unsigned &id_num_,
                                      const unsigned &poly_order_,
...
template <int dim, int spacedim>
void GenericCell<dim, spacedim>::detach_FEValues(
  FE_val_ptr &cell_quad_fe_vals_,
  FEFace_val_ptr &face_quad_fe_vals_,
  FE_val_ptr &cell_supp_fe_vals_,
  FEFace_val_ptr &face_supp_fe_vals_)
...
template <int dim, int spacedim>
double GenericCell<dim, spacedim>::get_error_on_faces(
...
template <int dim, int spacedim>
void GenericCell<dim, spacedim>::reinit_cell_fe_vals()
{
...
template <int dim, int spacedim>
void GenericCell<dim, spacedim>::reinit_face_fe_vals(unsigned i_face)
{
...
void GenericCell<dim, spacedim>::project_essential_BC_to_face(
...
template <int dim, int spacedim>
template <typename BasisType, typename func_out_type>
void GenericCell<dim, spacedim>::project_to_elem_basis(
  const TimeFunction<dim, func_out_type> &func,
...
template <int dim, int spacedim>
int GenericCell<dim, spacedim>::do_not_count_face_dofs = -1;

template <int dim, int spacedim>
void GenericCell<dim, spacedim>::assign_local_global_cell_data(
  const unsigned &i_face,
...
template <int dim, int spacedim>
void GenericCell<dim, spacedim>::assign_ghost_cell_data(
  const unsigned &i_face,
...
template <int dim, int spacedim>
void GenericCell<dim, spacedim>::assign_local_cell_data(
  const unsigned &i_face,
  const unsigned &local_num_,
...
template <int dim, int spacedim>
void GenericCell<dim, spacedim>::internal_vars_errors(const eigen3mat &,
                                                      const eigen3mat &,
                                                      double &,
                                                      double &)
{
